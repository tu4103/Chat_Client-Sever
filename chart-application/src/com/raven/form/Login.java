...
public class Login extends javax.swing.JPanel {
                                ...
                                if (os.length > 0) {
                                    ...
                                    if (action) {
                                     ...
                                     // Login successful, display the success message
                                        MessageDialog.showSuccessMessage("Login successful. Welcome!");
                                    } else {
                                        //  password wrong
                                        PublicEvent.getInstance().getEventMain().showLoading(false);
                                        MessageDialog.showMessage("Incorrect password. Please try again.");
    ...
    public class MessageDialog {
        ...
        public static void showSuccessMessage(String message) {
            JOptionPane.showMessageDialog(null, message, "Login Success", JOptionPane.INFORMATION_MESSAGE);
        }
    }
